...
public class List {
    ...
    */
    ...
    /*
    Returns a list object containing elements, including start and
    excluding end. The first parameter indicates the start and the
    second parameter indicates the end. Returns null and print
    ...
    */
    public List subList(int start, int end)
    {
        ...
        if (start >= 0 && end >= 0 && start < end && end <= size()) {
            // E[] newint = ((E[])new Object[end - start]);
            int count = 0;
