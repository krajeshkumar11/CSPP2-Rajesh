		        ...
		        while (stdin.hasNext()) {
		            ...
		            switch (tokens[0]) {
                        ...
                        if(tokens.length == 2){
                            ...
                            String[] sublist = new String[temp[1] - temp[0]];
                            Object[] listobj = new Object[temp[1] - temp[0]];
                            listobj = listString.subList(temp[0], temp[1]);
                            if(listobj != null){
                                for (int i = 0; i < listobj.length ;i++ ) {
                                    sublist[i] = (String) listobj[i];
                                }
                                String st = "[";
                        ...
                        if(tokens.length==2){
                            ...
                            val.addAll(temp);
                            System.out.println(listString.equals(val));
                        }
                        break;
                        case "clear":
                        listString.clear();
	       		...
	       		while (stdin.hasNext()) {
		            ...
		            switch (tokens[0]) {
		                ...
		                if(tokens.length == 2){
			                ...
			                Integer[] sublist = new Integer[temp[1] - temp[0]];
			                Object[] listobj = new Object[temp[1] - temp[0]];
			                listobj = listInteger.subList(temp[0], temp[1]);
			                if(listobj != null){
				                for (int i = 0; i < listobj.length ;i++ ) {
				                	sublist[i] = (Integer) listobj[i];
				                }
				                String st = "[";
				                for (int i = 0; i < sublist.length ; i++ ) {
				                	st += sublist[i];
		                ...
		                if(tokens.length==2){
			                ...
			                // listInteger.addAll(temp);
			                List<Integer> val = new List();
			                val.addAll(temp);
			                // String st = val.toString();
			                // st = st.replace("[", "");
			                // st = st.replace("]", "");
			                // t1 = st.split(",");
			                // temp = new Integer[t1.length];
			                // for (int i = 0;i < temp.length; i++ ) {
			                // 	temp[i] = Integer.parseInt(t1[i]);
			                // }
		                	System.out.println(listInteger.equals(val));
		                }
		                break;
		                case "clear":
		                listInteger.clear();
	        	...
	        	while (stdin.hasNext()) {
		            ...
		            switch (tokens[0]) {
                        ...
                        if(tokens.length == 2){
                            ...
                            Float[] sublist = new Float[temp[1] - temp[0]];
                            Object[] listobj = new Object[temp[1] - temp[0]];
                            listobj = listFloat.subList(temp[0], temp[1]);
                            if(listobj != null){
                                for (int i = 0; i < listobj.length ;i++ ) {
                                    sublist[i] = (Float) listobj[i];
                                }
                                String st = "[";
                                for (int i = 0; i < sublist.length ; i++ ) {
                                    st += sublist[i];
                        ...
                        if(tokens.length==2){
                            ...
                            // listFloat.addAll(temp);
                            List<Float> val = new List();
                            val.addAll(temp);
                            System.out.println(listFloat.equals(val));
                        }
                        break;
                        case "clear":
                        listFloat.clear();
			    ...
			    while (stdin.hasNext()) {
		            ...
		            switch (tokens[0]) {
                        ...
                        if(tokens.length == 2){
                            ...
                            Character[] sublist = new Character[temp[1] - temp[0]];
                            Object[] listobj = new Object[temp[1] - temp[0]];
                            listobj = listCharacter.subList(temp[0], temp[1]);
                            if(listobj != null){
                                for (int i = 0; i < listobj.length ;i++ ) {
                                    sublist[i] = (Character) listobj[i];
                                }
                                String st = "[";
                                for (int i = 0; i < sublist.length ; i++ ) {
                                    st += sublist[i];
                        ...
                        if(tokens.length==2){
                            ...
                            // listCharacter.addAll(temp);
                            List<Character> val = new List();
                            val.addAll(temp);
                            // String st = val.toString();
                            // st = st.replace("[", "");
                            // st = st.replace("]", "");
                            // t1 = st.split(",");
                            // temp = new Character[t1.length];
                            // for (int i = 0;i < temp.length; i++ ) {
                            //  temp[i] = Character.parseInt(t1[i]);
                            // }
                            System.out.println(listCharacter.equals(val));
                        }
                        break;
                        case "clear":
                        listCharacter.clear();
		        ...
		        while (stdin.hasNext()) {
		            ...
		            switch (tokens[0]) {
                        ...
                        if(tokens.length == 2){
                            ...
                            Double[] sublist = new Double[temp[1] - temp[0]];
                            Object[] listobj = new Object[temp[1] - temp[0]];
                            listobj = listDouble.subList(temp[0], temp[1]);
                            if(listobj != null){
                                for (int i = 0; i < listobj.length ;i++ ) {
                                    sublist[i] = (Double) listobj[i];
                                }
                                String st = "[";
                                for (int i = 0; i < sublist.length ; i++ ) {
                                    st += sublist[i];
                        ...
                        if(tokens.length==2){
                            ...
                            // listDouble.addAll(temp);
                            List<Double> val = new List();
                            val.addAll(temp);

                            System.out.println(listDouble.equals(val));
                        }
                        break;
                        case "clear":
                        listDouble.clear();
